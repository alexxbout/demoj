<template>
    <button @click.prevent="emits('@click')" class="flex items-center justify-center w-full h-20 p-5 text-3xl text-center rounded-3xl aspect-square disabled:grayscale" :style="styles" :disabled="props.disabled">
